...
export default function NotFound1({
  ...
  return (
    <div
      className={cn(
        'retro grid w-full place-content-center gap-5 bg-background px-4 py-16 text-center md:py-24 min-h-screen',
        className,
      )}
    ...
    >
      ...
      <p className="retro text-white/50 text-xs">{description}</p>
